...
def generate_launch_description():
    ...
    kinematics_yaml = load_yaml(
        'robotiq_gripper_moveit_config', 'config/kinematics.yaml'
    )
    ...
    ompl_planning_yaml = load_yaml(
        'robotiq_gripper_moveit_config', 'config/ompl_planning.yaml'
    )
    ompl_planning_pipeline_config['move_group'].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    moveit_simple_controllers_yaml = load_yaml(
        'robotiq_gripper_moveit_config', 'config/custom_moveit_controllers.yaml'
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory(
        'robotiq_gripper_moveit_config'), 'config')
